...
public class TriangleTests {
	...
	public void test_true_test2_area() {
		double[] temp = {3.0, 3.0, 3.0};
		Triangle myTriangle = new Triangle(temp);
		double myArea = myTriangle.area();
		assertEquals(myArea, 3.9, 0.01);
	}
	
	@Test
	public void test_true_test3_type() {
		double[] temp = {15, 27, 30};
		Triangle myTriangle = new Triangle(temp);
		String myType = myTriangle.determineType();
		assertEquals(myType, "Scalene");
	}
	...
	@Test
	public void test_true_test3_area() {
		double[] temp = {15, 27, 30};
		Triangle myTriangle = new Triangle(temp);
		double myArea = myTriangle.area();
		assertEquals(myArea, 202.05, 0.01);
	}
	
	@Test
	public void test_true_test4_type() {
		double[] temp = {26, 4, 2};
		Triangle myTriangle = new Triangle(temp);
		String myType = myTriangle.determineType();
		assertEquals(myType, "None");
	}
	
	@Test
	public void test_true_test4_area() {
		double[] temp = {26, 4, 2};
		Triangle myTriangle = new Triangle(temp);
		double myArea = myTriangle.area();
		assertEquals(myArea, 0.0, 0.01);
	}
